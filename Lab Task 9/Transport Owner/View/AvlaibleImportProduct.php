...
include '../Controller/ReturnAvlaibleImport.php';
$res=reqimportprreturn();
...
<body>
<h3 style="text-align:center;">Import Product</h3>
<form >
    <table bgcolor="black" width="1200" align="center">
        <tr bgcolor="#D6EEEE">
            ...
            <th width="150">Pick Up Terminal</th>
