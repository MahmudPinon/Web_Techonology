<?php  
 ...
 {  
  ...
  $oldhelpername=test_input($_POST["prevdrivername"]);
  $newhelpername=test_input($_POST["newdrivername"]);
  $newdriverphonenumber=test_input($_POST["newphnnumber"]);
  $newdriverlicense=test_input($_POST["licensenumber"]);

  $dateofbirth=($_POST["ddob"]);
  $dateofbirth1=($_POST["hdob"]);
  ...
  $date2 = new DateTime($dateofbirth1);
  $interval2 = $today_date->diff($date1);
  $years2 = $interval1->y;
...
<style>
  ...
  margin:auto;
      ...
      <body>  
           ...
           <div>  
              <fieldset >
                <legend><b>Update Driver and Helper</legend>                
            ...
            <tr>
						<td>Previous Helper Name</td>
						<td><input type="text" placeholder="Enter Old Helper Name" name="prevhelpername" value="" ></td>
					  </tr>
            <tr>
            <td colspan="2"><hr></td>
            </tr>
            <tr>
						<td>New Helper Name</td>
						<td><input type="text" placeholder="Enter New Helper Name" name="newhelpername" value="" ></td>
					  </tr>
            <tr>
            <td colspan="2"><hr></td>
            </tr> 
